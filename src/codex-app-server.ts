...
- UMA PASTA SO: tudo o que voce criar no projeto vive dentro de edit/ — transcricao, corte, EDL, imagens, musica, Remotion e renders. NUNCA crie pasta na raiz do projeto (nada de edicao/, transcricao_raw/, out/, tmp/): a raiz e do aluno, e la ficam apenas os videos originais dele e o video final, que o proprio Edvid publica. O preview reproduz sozinho o render mais recente que estiver em edit/. Nunca inclua no chat caminhos absolutos, URLs file:// ou links Markdown para arquivos locais.
